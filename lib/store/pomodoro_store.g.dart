...
mixin _$PomodoroStore on _PomodoroStore, Store {
  ...
  void decremenarTempoTrabalho() {
    final _$actionInfo = _$_PomodoroStoreActionController.startAction(
        name: '_PomodoroStore.decremenarTempoTrabalho');
    try {
      return super.decremenarTempoTrabalho();
    } finally {
      _$_PomodoroStoreActionController.endAction(_$actionInfo);
    }
  }
  ...
  void decremenarTempoDescanso() {
    final _$actionInfo = _$_PomodoroStoreActionController.startAction(
        name: '_PomodoroStore.decremenarTempoDescanso');
    try {
      return super.decremenarTempoDescanso();
    } finally {
      _$_PomodoroStoreActionController.endAction(_$actionInfo);
    }
  }
